...
const adapter = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$prisma$2f$adapter$2d$pg$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PrismaPg"]({
    connectionString: ("TURBOPACK compile-time value", "postgresql://neondb_owner:npg_v6IC2FrKSTEX@ep-polished-wind-adumo8c6-pooler.c-2.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require")
});
...
async function POST(req) {
    try {
        ...
        let dbUser = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.findUnique({
            where: {
                clerkId: userId
            }
        });
        if (!dbUser) {
            dbUser = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.create({
                data: {
                    clerkId: userId,
        ...
        const article = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].article.create({
            data: {
                title: body.title,
...
async function GET(req) {
    try {
        ...
        const articles = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].article.findMany({
            where: {
                user: {
                    clerkId: userId
                }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cc68519e._.js.map